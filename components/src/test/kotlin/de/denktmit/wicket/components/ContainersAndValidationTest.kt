...
class ContainersAndValidationTest : WicketTestBase() {
  ...
  fun `custom border and list border contracts`() {
    ...
    assertThatThrownBy { listBorder.addOrReplace(DmLabel("x", "y")) }
      .isInstanceOf(UnsupportedOperationException::class.java)
    assertThatThrownBy { listBorder.remove(DmLabel("x", "y")) }
      .isInstanceOf(UnsupportedOperationException::class.java)
    assertThatThrownBy { listBorder.remove("x") }
      .isInstanceOf(UnsupportedOperationException::class.java)
    assertThatThrownBy { listBorder.removeAll() }
      .isInstanceOf(UnsupportedOperationException::class.java)
    assertThatThrownBy { listBorder.replace(DmLabel("x", "y")) }
      .isInstanceOf(UnsupportedOperationException::class.java)
    assertThatThrownBy { listBorder.queue(DmLabel("x", "y")) }
      .isInstanceOf(UnsupportedOperationException::class.java)
  ...
  fun `autocomplete and multiselect borders keep constructor state`() {
    ...
    assertThat(auto.get("textFieldValue")).isNotNull
    assertThat(auto.get("labelValue")).isNotNull
