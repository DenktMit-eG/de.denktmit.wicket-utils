...
class ModelUtilsAndMetadataTest {
  ...
  private class NullModelLabel(id: String) : Label(id) {
    override fun initModel(): IModel<*>? = null
  }
  ...
  @Test
  fun `fieldModel throws when initModel returns null`() {
    val tester =
      WicketTester(
        object : WebApplication() {
          override fun getHomePage(): Class<out Page> = TestHomePage::class.java
